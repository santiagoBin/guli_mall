/*
 ...
 Source Schema         : gulimall-sms

 Target Server Type    : MySQL
 Target Server Version : 80029
 File Encoding         : 65001

 Date: 04/11/2022 21:09:07
*/
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '优惠券信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_coupon_history`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '优惠券领取历史记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_coupon_spu_category_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '优惠券分类关联' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_coupon_spu_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '优惠券与产品关联' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_home_adv`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '首页轮播广告' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_home_subject`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '首页专题表【jd首页下面很多专题，每个专题链接新的页面，展示专题商品信息】' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_home_subject_spu`  (
  ...
  `sort` int NULL DEFAULT NULL COMMENT '排序',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '专题商品' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_member_price`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 30 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '商品会员价格' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_member_price
-- ----------------------------
INSERT INTO `sms_member_price` VALUES (4, 34, 1, '普通会员', 4900.0000, 1);
INSERT INTO `sms_member_price` VALUES (5, 34, 2, '银牌会员', 4869.0000, 1);
INSERT INTO `sms_member_price` VALUES (6, 34, 3, '金牌会员', 4819.0000, 1);
INSERT INTO `sms_member_price` VALUES (7, 35, 1, '普通会员', 4900.0000, 1);
INSERT INTO `sms_member_price` VALUES (8, 35, 2, '银牌会员', 4866.0000, 1);
INSERT INTO `sms_member_price` VALUES (9, 35, 3, '金牌会员', 4800.0000, 1);
INSERT INTO `sms_member_price` VALUES (10, 36, 1, '普通会员', 4600.0000, 1);
INSERT INTO `sms_member_price` VALUES (11, 36, 2, '银牌会员', 4566.0000, 1);
INSERT INTO `sms_member_price` VALUES (12, 36, 3, '金牌会员', 4536.0000, 1);
INSERT INTO `sms_member_price` VALUES (13, 37, 1, '普通会员', 3900.0000, 1);
INSERT INTO `sms_member_price` VALUES (14, 37, 2, '银牌会员', 3860.0000, 1);
INSERT INTO `sms_member_price` VALUES (15, 37, 3, '金牌会员', 3826.0000, 1);
INSERT INTO `sms_member_price` VALUES (16, 38, 1, '普通会员', 3900.0000, 1);
INSERT INTO `sms_member_price` VALUES (17, 38, 2, '银牌会员', 3880.0000, 1);
INSERT INTO `sms_member_price` VALUES (18, 38, 3, '金牌会员', 3860.0000, 1);
INSERT INTO `sms_member_price` VALUES (19, 39, 1, '普通会员', 3900.0000, 1);
INSERT INTO `sms_member_price` VALUES (20, 39, 2, '银牌会员', 3880.0000, 1);
INSERT INTO `sms_member_price` VALUES (21, 39, 3, '金牌会员', 3865.0000, 1);
INSERT INTO `sms_member_price` VALUES (22, 82, 1, '普通会员', 0.0100, 1);
INSERT INTO `sms_member_price` VALUES (23, 82, 2, '银牌会员', 0.0100, 1);
INSERT INTO `sms_member_price` VALUES (24, 82, 3, '金牌会员', 0.0100, 1);
INSERT INTO `sms_member_price` VALUES (25, 83, 1, '普通会员', 0.0100, 1);
INSERT INTO `sms_member_price` VALUES (26, 83, 2, '银牌会员', 0.0100, 1);
INSERT INTO `sms_member_price` VALUES (27, 83, 3, '金牌会员', 0.0100, 1);
INSERT INTO `sms_member_price` VALUES (28, 84, 1, '普通会员', 0.0100, 1);
INSERT INTO `sms_member_price` VALUES (29, 84, 2, '银牌会员', 0.0100, 1);
INSERT INTO `sms_member_price` VALUES (30, 84, 3, '金牌会员', 0.0100, 1);
...
-- ----------------------------
INSERT INTO `sms_seckill_promotion` VALUES (1, '1', '2022-10-22 00:00:00', '2022-11-16 00:00:00', 1, NULL, NULL);
...
CREATE TABLE `sms_seckill_session`  (
  ...
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '秒杀活动场次' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_seckill_session
-- ----------------------------
INSERT INTO `sms_seckill_session` VALUES (1, '1', '2022-10-11 10:45:00', '2022-10-12 00:00:00', 1, NULL);
INSERT INTO `sms_seckill_session` VALUES (2, '2', '2022-10-11 10:45:00', '2022-10-12 21:33:37', 1, '2022-10-10 21:33:43');
...
CREATE TABLE `sms_seckill_sku_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '秒杀活动商品关联' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_seckill_sku_relation
-- ----------------------------
INSERT INTO `sms_seckill_sku_relation` VALUES (1, NULL, 1, 35, 3000.0000, 100, 1, 0);
INSERT INTO `sms_seckill_sku_relation` VALUES (2, NULL, 2, 36, 1000.0000, 100, 1, 1);
...
CREATE TABLE `sms_sku_full_reduction`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '商品满减信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_sku_full_reduction
-- ----------------------------
INSERT INTO `sms_sku_full_reduction` VALUES (7, 35, 4000.0000, 100.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (8, 36, 4000.0000, 100.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (9, 37, 3000.0000, 100.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (13, 83, 100.0000, 10.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (14, 84, 100.0000, 10.0000, NULL);
...
CREATE TABLE `sms_sku_ladder`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '商品阶梯价格' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_sku_ladder
-- ----------------------------
INSERT INTO `sms_sku_ladder` VALUES (7, 35, 2, 0.95, 4900.0000, 0);
INSERT INTO `sms_sku_ladder` VALUES (8, 36, 2, 0.95, 4600.0000, 0);
INSERT INTO `sms_sku_ladder` VALUES (9, 37, 2, 0.95, 3900.0000, 0);
INSERT INTO `sms_sku_ladder` VALUES (13, 83, 1, 0.01, 0.0100, 0);
INSERT INTO `sms_sku_ladder` VALUES (14, 84, 1, 0.01, 0.0100, 0);
...
CREATE TABLE `sms_spu_bounds`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 20 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '商品spu积分设置' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_spu_bounds
-- ----------------------------
INSERT INTO `sms_spu_bounds` VALUES (7, 24, 1.0000, 1.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (8, 25, 500.0000, 500.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (9, 26, 500.0000, 500.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (10, 27, 520.0000, 520.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (11, 28, 500.0000, 500.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (12, 29, 300.0000, 300.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (13, 30, 600.0000, 600.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (14, 31, 500.0000, 500.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (15, 32, 500.0000, 500.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (16, 33, 500.0000, 500.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (17, 35, 300.0000, 300.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (18, 36, 100.0000, 100.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (19, 37, 1.0000, 1.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (20, 38, 1.0000, 1.0000, NULL);
